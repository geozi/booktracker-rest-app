...
/**
 * The {@link PublisherReadOnlyDTO} class is the DTO equivalent of the
 * {@link model.Publisher} class specifically adjusted to read-only operations.
 * It inherits from the {@link BaseDTO} class.
 */
@NoArgsConstructor
@Getter
@Setter
public class PublisherReadOnlyDTO extends BaseDTO {
    @NotNull
    ...
    public PublisherReadOnlyDTO(Long id) {
        super.setId(id);
    }

    public PublisherReadOnlyDTO(Long id, String name, String phoneNumber, String email,
